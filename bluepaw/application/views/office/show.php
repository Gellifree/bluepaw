        ...
        <div class="card shadow-sm bg-light m-0" style="width: 250px">
            ...
            <div class="card-body ">
                ...
                <ul class="list-group">
                    ...
                    <h4 class="card-title"> <?php echo lang('office_name'); ?> </h4>
                    <li class="list-group-item">
            ...
            <?php echo anchor(base_url('office/list'), lang('back_to_list'), ['class' => 'btn btn-primary p-2']); ?>
        </div>
        </div>
        
        <div class="col">
            <div class="card shadow-sm bg-light m-0 p-3 ">
            <h4 class="card-title"> <?php echo lang('office_capacity'); ?> </h4>
            <p class="card-text"><?=$record->kapacitas; ?></p>
            <?php echo anchor(base_url('office/update/'.$record->id), lang('edit'), ['class' => 'btn btn-warning']); ?>
            </div>

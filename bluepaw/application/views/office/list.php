...
<title> <?php echo lang('office_title_list') ?> </title>
...
<table class="table table-hover">
        ...
        <?php foreach ($records as $record): ?>
            <tr>    
                <td> <?=$record->nev?> </td>
                <td> <?=$record->kapacitas?> </td>
                <td> <?=$record->epulet_nev?> </td>
                <td class="text-right">
                    <?php echo anchor(base_url('office/list/'.$record->id), '<i class="fas fa-info-circle"> </i>'); ?>
                    <?php echo anchor(base_url('office/delete/'.$record->id), '<i class="fas fa-trash"> </i>'); ?>
                    <?php echo anchor(base_url('office/update/'.$record->id), '<i class="fas fa-edit"> </i>'); ?>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
...
<?php endif; ?>
    <?php echo anchor(base_url('office/insert'), lang('add'), ['class' => 'btn btn-primary']); ?>
</div>

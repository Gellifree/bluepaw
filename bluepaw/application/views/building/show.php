...
<title> <?php echo lang('building_title_one') ?> </title>
...
<div class = 'container '>
    <div class="row">
        ...
        <div class="card shadow-sm bg-light m-0" style="width: 250px">
            ...
            <img src='/bluepaw/public/img/building_rect.png' width='' class="card-img-top"/>
            ...
            <div class="card-body ">
                ...
                <ul class="list-group">
                    ...
                    <h4 class="card-title"> <?php echo lang('building_name'); ?> </h4>
                    <li class="list-group-item">
            ...
            <?php echo anchor(base_url('building/list'), lang('back_to_list'), ['class' => 'btn btn-primary p-2']); ?>
        </div>
        </div>

...
<title> <?php echo lang('responsibility_title_one') ?> </title>
...
<div class = 'container '>
    <div class="row">
        ...
        <div class="card shadow-sm bg-light m-0" style="width: 250px">
            ...
            <div class="card-body ">
                ...
                <ul class="list-group">
                    ...
                    <h4 class="card-title"> <?php echo lang('responsibility_name'); ?> </h4>
                    <li class="list-group-item">
            ...
            <?php echo anchor(base_url('responsibilities/list'), lang('back_to_list'), ['class' => 'btn btn-primary p-2']); ?>
        </div>
        </div>
        ...
        <div class="col">
            ...
            <?php echo anchor(base_url('responsibilities/update/'.$record->id), lang('edit'), ['class' => 'btn btn-warning']); ?>
            </div>
        </div>
